...
class Func
{
    ...
    public static function getRand($length = 24, $codeAlphabet = null)
    {
        $rand = '';

        !$codeAlphabet && $codeAlphabet = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789';
        $max = strlen($codeAlphabet) - 1;
        for ($i=0; $i < $length; $i++)
            $rand .= $codeAlphabet[static::crypto_rand_secure(0, $max)];
